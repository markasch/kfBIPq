...
We will formulate the inversion for the stochastic ensemble filter (EKI, see @sec-EnKF and @sec-enkf) and then for the ensemble transfer filter (ETKI, see @sec-ensrf), the latter having a better convergence behavior.
